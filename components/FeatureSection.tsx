      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 border border-[#334155]/30">
          ...
          <div className="flex flex-col lg:border-r border-[#334155]/30">
            {/* Feature 1 */}
            <div className="flex-1 flex flex-col p-8 md:p-12 border-b border-[#334155]/30 bg-[#0A0D14] hover:bg-[#111622] transition-colors duration-500 group relative">
            ...
            {/* Feature 2 */}
            <div className="flex-1 flex flex-col p-8 md:p-12 bg-[#0A0D14] border-b lg:border-b-0 border-[#334155]/30 hover:bg-[#111622] transition-colors duration-500 group relative">
              <div className="absolute top-0 left-0 w-[3px] h-full bg-gradient-to-b from-[#1FE0E4] via-[#3B82F6] to-[#9333EA] scale-y-0 origin-top group-hover:scale-y-100 transition-transform duration-500 ease-out" />
              <span className="text-[#1FE0E4] text-[9px] tracking-[0.3em] font-['JetBrains_Mono'] uppercase mb-8 block">
                F - 02
              </span>
          ...
          <div className="flex flex-col lg:border-r border-[#334155]/30 items-center justify-center p-12 bg-[#0A0D14] border-b lg:border-b-0 hover:bg-[#111622] transition-colors duration-500">
          ...
          <div className="flex flex-col">
            ...
            {/* Feature 4 */}
            <div className="flex-1 flex flex-col p-8 md:p-12 bg-[#0A0D14] hover:bg-[#111622] transition-colors duration-500 group relative">
              <div className="absolute top-0 right-0 w-[3px] h-full bg-gradient-to-b from-[#1FE0E4] via-[#3B82F6] to-[#9333EA] scale-y-0 origin-top group-hover:scale-y-100 transition-transform duration-500 ease-out" />
              <span className="text-[#1FE0E4] text-[9px] tracking-[0.3em] font-['JetBrains_Mono'] uppercase mb-8 block">
                F - 04
              </span>
